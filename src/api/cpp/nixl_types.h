...
namespace nixlEnumStrings {
    ...
    inline std::string memTypeStr(const nixl_mem_t &mem) {
    ...
    inline std::string xferOpStr (const nixl_xfer_op_t &op) {
    ...
    inline std::string statusStr (const nixl_status_t &status) {
        switch (status) {
